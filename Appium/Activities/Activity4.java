...
public class Activity4 {
    ...
    public void contactsTest() {
    	...
    	driver.findElement(AppiumBy.xpath("//com.google.android.material.floatingactionbutton.FloatingActionButton[@content-desc=\"Create contact\"]\r\n"
    			+ "")).click();
       ...
       /* driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text=\"+1\"]/android.view.View[3]")).click();
        driver.findElement(AppiumBy.xpath("	\r\n"
        		+ "//android.widget.EditText[@text=\"+1\"]/android.view.View[1]")).sendKeys("999912121"); */
