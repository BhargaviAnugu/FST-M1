...
public class Activity6 {
	...
	public void volume75Test() {
		...
		System.out.println("50% volume text " +volumeText);
	...
	public void volume25Test() {
		...
		//String volumeText = driver.findElement(AppiumBy.xpath("//android.widget.TextView[contains(@text, '%')]")).getText();
		String volumeText = driver
			.findElement(AppiumBy.xpath("//android.view.View/android.widget.TextView[contains(@text, '%')]")).getText();
			
		System.out.println("25% text is:  " +volumeText);
